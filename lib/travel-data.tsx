...
export const destinations: Record<string, Destination> = {
  accra: {
    ...
    timezone: "GMT",
    timezoneOffset: "+0",
    description: "The vibrant capital of Ghana, known for its rich history, bustling markets, and beautiful beaches.",
    mapEmbedUrl:
    ...
    visaInfo: {
      ...
      notes: "Visa on arrival costs approximately $150 USD. E-visa available online.",
    },
    costOfLiving: {
      meal: "$5-15",
      coffee: "$2-4",
    ...
    healthInfo: {
      vaccinations: ["Yellow Fever (required)", "Hepatitis A & B", "Typhoid", "Malaria prophylaxis recommended"],
      healthTips: [
    ...
    cuisine: [
      { dish: "Jollof Rice", description: "Spicy tomato rice dish, a West African staple" },
      { dish: "Banku & Tilapia", description: "Fermented corn dough with grilled fish" },
      { dish: "Fufu", description: "Pounded cassava or plantain served with soup" },
      { dish: "Kelewele", description: "Spicy fried plantains, popular street food" },
      { dish: "Red Red", description: "Black-eyed peas stew with fried plantains" },
    ],
    commonPhrases: [
      ...
      { english: "Goodbye", local: "Nante yie", pronunciation: "nan-teh yee-eh" },
    ...
    bestTimeToVisit: {
      ...
      recommendation: "Visit during November-February for the best weather and cultural festivals",
    },
    packingList: [
    ...
    transportation: {
      metro: "No metro system - taxis and tro-tros (minibuses) are main transport",
    ...
    restaurants: [
      ...
      { name: "Santoku", cuisine: "Japanese", priceRange: "$$$", description: "Modern Japanese dining experience" },
      { name: "Skybar 25", cuisine: "International", priceRange: "$$$", description: "Rooftop dining with city views" },
    ],
    churches: [
      {
    ...
    mosques: [
      ...
      { name: "Nima Mosque", address: "Nima, Accra", description: "Historic community mosque" },
    ],
    attractions: [
      {
      ...
      { name: "Labadi Beach", type: "Beach", description: "Popular beach with live music and local food" },
      { name: "Makola Market", type: "Market", description: "Bustling traditional market for local goods" },
      { name: "National Museum of Ghana", type: "Museum", description: "Showcases Ghana's cultural heritage" },
      {
        name: "Jamestown",
    ...
    events: [
      ...
      { name: "Afrochella", date: "December", description: "Celebration of African culture and music" },
      { name: "Homowo Festival", date: "May-August", description: "Traditional Ga harvest festival" },
    ],
    hotels: [
      {
      ...
      { name: "Labadi Beach Hotel", stars: 4, area: "La", description: "Beachfront resort with pools and spa" },
      { name: "Movenpick Ambassador Hotel", stars: 5, area: "Ridge", description: "Elegant hotel in diplomatic area" },
      { name: "Alisa Hotel", stars: 4, area: "North Ridge", description: "Boutique hotel with rooftop pool" },
    ],
    banks: [
      { name: "Ecobank Ghana", branches: "Multiple locations across Accra" },
      { name: "Standard Chartered Bank", branches: "High Street, Osu, Airport" },
      { name: "Stanbic Bank", branches: "Independence Avenue, Tema" },
    ],
    holidays: [
  ...
  lagos: {
    ...
    visaInfo: {
      ...
      notes: "E-visa available online. Processing takes 5-7 business days. Cost: $160 USD for tourist visa.",
    },
    costOfLiving: {
      meal: "$3-12",
      coffee: "$2-5",
    ...
    healthInfo: {
      vaccinations: ["Yellow Fever (required)", "Hepatitis A & B", "Typhoid", "Meningitis", "Malaria prophylaxis"],
      healthTips: [
    ...
    cuisine: [
      ...
      { dish: "Akara", description: "Fried bean cakes, popular breakfast item" },
    ],
    commonPhrases: [
    ...
    bestTimeToVisit: {
      ...
      recommendation: "December-February offers the best weather and numerous cultural events",
    },
    packingList: [
    ...
    restaurants: [
      ...
      { name: "Nkoyo", cuisine: "Nigerian", priceRange: "$$$", description: "Upscale Nigerian dining experience" },
      { name: "Shiro", cuisine: "Asian Fusion", priceRange: "$$$", description: "Contemporary Asian cuisine" },
      { name: "Yellow Chilli", cuisine: "Indian", priceRange: "$$", description: "Popular Indian restaurant chain" },
      {
    ...
    churches: [
      ...
      { name: "Holy Cross Cathedral", address: "Catholic Mission Street", description: "Beautiful Catholic cathedral" },
      {
    ...
    attractions: [
      { name: "Nike Art Gallery", type: "Art Gallery", description: "Largest art gallery in West Africa" },
      { name: "Lekki Conservation Centre", type: "Nature Reserve", description: "Nature reserve with canopy walkway" },
      { name: "Freedom Park", type: "Historical Park", description: "Former colonial prison turned cultural center" },
      { name: "Elegushi Beach", type: "Beach", description: "Popular private beach with entertainment" },
      { name: "National Museum Lagos", type: "Museum", description: "Showcases Nigerian art and archaeology" },
    ],
    events: [
      { name: "Lagos Fashion Week", date: "October", description: "Premier fashion event in Africa" },
      { name: "Felabration", date: "October", description: "Annual music festival celebrating Fela Kuti" },
      { name: "Lagos International Jazz Festival", date: "April", description: "Celebration of jazz music" },
    ],
    hotels: [
      {
      ...
      { name: "The Wheatbaker", stars: 5, area: "Ikoyi", description: "Boutique luxury hotel" },
      {
      ...
      { name: "Four Points by Sheraton", stars: 4, area: "Oniru", description: "Contemporary hotel near the beach" },
    ],
    banks: [
      { name: "GTBank", branches: "Widespread across Lagos" },
      { name: "Access Bank", branches: "Multiple locations in VI, Ikoyi, Lekki" },
      { name: "Zenith Bank", branches: "Marina, Ikeja, Victoria Island" },
    ],
    holidays: [
  ...
  newyork: {
    ...
    timezoneOffset: "-5/-4",
    description: "The city that never sleeps, a global center for culture, finance, and entertainment.",
    mapEmbedUrl:
    ...
    climate: {
      ...
      description: "Four distinct seasons with cold winters and hot, humid summers",
    },
    visaInfo: {
      required: {
        "Visa Waiver Program": "ESTA required for 90-day stays (most EU, Japan, etc.)",
        "Other Countries": "B-2 tourist visa required",
        "Canadian Citizens": "No visa required",
      },
      notes: "ESTA costs $21 and is valid for 2 years. Apply at least 72 hours before travel.",
    },
    costOfLiving: {
      meal: "$15-40",
      coffee: "$4-7",
    ...
    healthInfo: {
      vaccinations: ["No special vaccinations required", "Routine vaccinations recommended"],
      healthTips: [
    ...
    cuisine: [
      { dish: "New York Pizza", description: "Thin-crust pizza sold by the slice" },
      { dish: "Bagels with Lox", description: "Toasted bagel with cream cheese and smoked salmon" },
      { dish: "Pastrami on Rye", description: "Classic deli sandwich" },
      { dish: "Hot Dogs", description: "Street cart staple with various toppings" },
      { dish: "Cheesecake", description: "Rich, creamy New York-style dessert" },
    ],
    commonPhrases: [
      { english: "Hello", local: "Hey / What's up", pronunciation: "standard English" },
      { english: "Thank you", local: "Thanks", pronunciation: "standard English" },
      { english: "Excuse me", local: "Excuse me / Sorry", pronunciation: "standard English" },
      { english: "Subway", local: "Train", pronunciation: "New Yorkers call it 'the train'" },
      { english: "Manhattan", local: "The City", pronunciation: "locals refer to Manhattan as 'the city'" },
    ],
    culturalEtiquette: [
    ...
    bestTimeToVisit: {
      ...
      recommendation: "Late spring (May) or early fall (September-October) for pleasant weather and fewer crowds",
    },
    packingList: [
    ...
    transportation: {
      metro: "Extensive subway system (24/7) - use MetroCard or OMNY contactless payment",
    ...
    restaurants: [
      { name: "Katz's Delicatessen", cuisine: "Jewish Deli", priceRange: "$$", description: "Iconic deli since 1888" },
      {
        name: "Le Bernardin",
      ...
      { name: "Joe's Pizza", cuisine: "Pizza", priceRange: "$", description: "Classic New York slice" },
      {
      ...
      { name: "Momofuku Noodle Bar", cuisine: "Asian", priceRange: "$$", description: "Innovative Asian cuisine" },
    ],
    churches: [
      {
    ...
    mosques: [
      ...
      { name: "Masjid Malcolm Shabazz", address: "Harlem", description: "Historic mosque in Harlem" },
    ],
    attractions: [
      { name: "Statue of Liberty", type: "Monument", description: "Iconic symbol of freedom" },
      { name: "Central Park", type: "Park", description: "843-acre urban park in Manhattan" },
      { name: "Times Square", type: "Entertainment District", description: "Bright lights and Broadway shows" },
      { name: "Metropolitan Museum of Art", type: "Museum", description: "World-renowned art museum" },
      { name: "Brooklyn Bridge", type: "Landmark", description: "Historic suspension bridge" },
    ],
    events: [
      { name: "New Year's Eve Ball Drop", date: "December 31", description: "Iconic Times Square celebration" },
      { name: "Macy's Thanksgiving Day Parade", date: "November", description: "Annual parade with giant balloons" },
      { name: "US Open Tennis", date: "August-September", description: "Grand Slam tennis tournament" },
    ],
    hotels: [
      { name: "The Plaza Hotel", stars: 5, area: "Midtown", description: "Legendary luxury hotel" },
      {
      ...
      { name: "The Bowery Hotel", stars: 4, area: "Lower East Side", description: "Boutique hotel with vintage charm" },
    ],
    banks: [
      { name: "Chase Bank", branches: "Extensive network citywide" },
      { name: "Bank of America", branches: "Multiple locations in all boroughs" },
      { name: "Citibank", branches: "Widespread across Manhattan and outer boroughs" },
    ],
    holidays: [
  ...
  tokyo: {
    ...
    timezone: "JST (GMT+9)",
    timezoneOffset: "+9",
    description: "A fascinating blend of traditional culture and cutting-edge technology, Japan's bustling capital.",
    mapEmbedUrl:
    ...
    climate: {
      ...
      rainySeasons: ["June-July (rainy season)", "September-October (typhoon season)"],
    ...
    visaInfo: {
      ...
      notes: "Tourist visa waiver for many countries. Ensure passport valid for duration of stay.",
    },
    costOfLiving: {
      meal: "$8-25",
      coffee: "$3-6",
    ...
    healthInfo: {
      vaccinations: ["No special vaccinations required", "Routine vaccinations up to date"],
      healthTips: [
        "Tap water is safe to drink",
    ...
    cuisine: [
      { dish: "Sushi & Sashimi", description: "Fresh raw fish, an art form in Japan" },
      { dish: "Ramen", description: "Noodle soup with various broths and toppings" },
    ...
    commonPhrases: [
      { english: "Hello", local: "こんにちは (Konnichiwa)", pronunciation: "kon-nee-chee-wah" },
    ...
    transportation: {
      metro: "Extensive and punctual subway/train system - get Suica or Pasmo IC card",
    ...
    restaurants: [
      ...
      { name: "Ichiran Ramen", cuisine: "Ramen", priceRange: "$", description: "Famous tonkotsu ramen chain" },
      {
        name: "Narisawa",
    ...
    churches: [
      ...
      { name: "Nikolai-do", address: "Kanda, Chiyoda", description: "Russian Orthodox cathedral" },
    ],
    mosques: [
      {
        name: "Tokyo Camii",
    ...
    attractions: [
      { name: "Senso-ji Temple", type: "Temple", description: "Tokyo's oldest Buddhist temple" },
      { name: "Tokyo Skytree", type: "Observation Tower", description: "Tallest structure in Japan" },
      { name: "Meiji Shrine", type: "Shinto Shrine", description: "Peaceful shrine in forested grounds" },
      { name: "Shibuya Crossing", type: "Landmark", description: "World's busiest pedestrian crossing" },
      { name: "Tsukiji Outer Market", type: "Market", description: "Famous fish market and food stalls" },
    ],
    events: [
      {
      ...
      { name: "Sumida River Fireworks", date: "July", description: "Spectacular fireworks festival" },
      { name: "Sanja Matsuri", date: "May", description: "One of Tokyo's largest festivals" },
    ],
    hotels: [
      { name: "The Peninsula Tokyo", stars: 5, area: "Marunouchi", description: "Luxury hotel near Imperial Palace" },
      {
      ...
      { name: "Aman Tokyo", stars: 5, area: "Otemachi", description: "Serene luxury in the city center" },
      { name: "Hotel Gracery Shinjuku", stars: 3, area: "Shinjuku", description: "Modern hotel with Godzilla head" },
    ],
    banks: [
      { name: "MUFG Bank", branches: "Extensive network across Tokyo" },
      { name: "Mizuho Bank", branches: "Major branches in business districts" },
      { name: "Japan Post Bank", branches: "Post offices throughout the city" },
    ],
    holidays: [
      { name: "New Year's Day", date: "January 1" },
  ...
  beijing: {
    ...
    timezone: "CST (GMT+8)",
    timezoneOffset: "+8",
    description: "China's capital, a city where ancient imperial history meets modern development.",
    mapEmbedUrl:
    ...
    climate: {
      ...
      description: "Hot, humid summers and cold, dry winters with four distinct seasons",
    },
    visaInfo: {
      required: {
        "Most Countries": "Visa required - apply before travel",
        "144-hour Transit": "Visa-free transit available for some nationalities",
        "Special Cases": "Check with Chinese embassy",
      },
      notes: "Tourist visa (L visa) required for most visitors. Processing takes 4-7 days. Cost varies by nationality.",
    },
    costOfLiving: {
      meal: "$3-15",
      coffee: "$3-6",
    ...
    healthInfo: {
      vaccinations: ["Routine vaccinations", "Hepatitis A & B recommended", "Typhoid recommended"],
      healthTips: [
    ...
    cuisine: [
      { dish: "Peking Duck", description: "Crispy roasted duck, Beijing's signature dish" },
      { dish: "Jiaozi (Dumplings)", description: "Steamed or fried dumplings with various fillings" },
      { dish: "Zhajiangmian", description: "Noodles with savory soybean paste" },
      { dish: "Hot Pot", description: "Interactive dining with boiling broth and ingredients" },
      { dish: "Baozi", description: "Steamed buns with meat or vegetable filling" },
    ],
    commonPhrases: [
      { english: "Hello", local: "你好 (Nǐ hǎo)", pronunciation: "nee how" },
      { english: "Thank you", local: "谢谢 (Xièxiè)", pronunciation: "shyeh-shyeh" },
      { english: "How much?", local: "多少钱 (Duōshao qián)", pronunciation: "dwor-shaow chyen" },
      { english: "Excuse me", local: "不好意思 (Bù hǎoyìsi)", pronunciation: "boo how-ee-suh" },
    ...
    bestTimeToVisit: {
      ...
      recommendation: "September-October for comfortable weather, clear skies, and autumn colors",
    },
    packingList: [
    ...
    restaurants: [
      ...
      { name: "TRB Hutong", cuisine: "European", priceRange: "$$$", description: "Fine dining in a historic temple" },
      {
    ...
    churches: [
      ...
      { name: "South Cathedral", address: "Xuanwumen", description: "Oldest Catholic church in Beijing" },
    ],
    mosques: [
      {
        name: "Niujie Mosque",
    ...
    attractions: [
      ...
      { name: "Temple of Heaven", type: "Temple", description: "Imperial complex for ceremonial purposes" },
      { name: "Summer Palace", type: "Palace", description: "Vast ensemble of lakes, gardens and palaces" },
      { name: "Tiananmen Square", type: "Public Square", description: "One of the world's largest public squares" },
    ],
    events: [
      {
      ...
      { name: "Dragon Boat Festival", date: "June (Lunar Calendar)", description: "Traditional boat races and zongzi" },
    ],
    hotels: [
      { name: "The Peninsula Beijing", stars: 5, area: "Wangfujing", description: "Luxury hotel near Forbidden City" },
      {
      ...
      { name: "The Opposite House", stars: 5, area: "Sanlitun", description: "Contemporary design hotel" },
      { name: "Hotel Jen Beijing", stars: 4, area: "CBD", description: "Modern hotel in business district" },
    ],
    banks: [
      { name: "Bank of China", branches: "Extensive network throughout Beijing" },
      { name: "ICBC", branches: "Major branches in all districts" },
      { name: "China Construction Bank", branches: "Widespread across the city" },
    ],
    holidays: [
...
export const flightRoutes: FlightRoute[] = [
  // Accra routes
  { from: "accra", to: "lagos", airlines: ["Africa World Airlines", "Air Peace", "ASKY Airlines"], duration: "1h 15m" },
  {
    from: "accra",
    to: "newyork",
  ...
  },
  {
    from: "accra",
    to: "beijing",
    airlines: ["Ethiopian Airlines (via Addis Ababa)", "Kenya Airways (via Nairobi)"],
    duration: "17h+",
  },

  // Lagos routes
  { from: "lagos", to: "accra", airlines: ["Africa World Airlines", "Air Peace", "ASKY Airlines"], duration: "1h 15m" },
  {
    from: "lagos",
    to: "newyork",
  ...
  { from: "newyork", to: "tokyo", airlines: ["ANA", "Japan Airlines", "United Airlines"], duration: "14h" },
  {
    from: "newyork",
    to: "beijing",
  ...
  { from: "tokyo", to: "newyork", airlines: ["ANA", "Japan Airlines", "United Airlines"], duration: "13h" },
  { from: "tokyo", to: "beijing", airlines: ["ANA", "Air China", "Japan Airlines"], duration: "3h 30m" },
  ...
  { from: "beijing", to: "tokyo", airlines: ["ANA", "Air China", "Japan Airlines"], duration: "3h 30m" },
]

export function getFlightRoute(from: string, to: string): FlightRoute | undefined {
...
export const distances: DistanceInfo[] = [
  ...
  { from: "accra", to: "newyork", distance: "8,270 km", flightDuration: "11h 30m" },
  { from: "accra", to: "tokyo", distance: "13,800 km", flightDuration: "18h+" },
  { from: "accra", to: "beijing", distance: "12,900 km", flightDuration: "17h+" },
  { from: "lagos", to: "newyork", distance: "8,500 km", flightDuration: "11h" },
  { from: "lagos", to: "tokyo", distance: "13,600 km", flightDuration: "17h+" },
  { from: "lagos", to: "beijing", distance: "12,700 km", flightDuration: "16h+" },
  { from: "newyork", to: "tokyo", distance: "10,850 km", flightDuration: "14h" },
  { from: "newyork", to: "beijing", distance: "11,000 km", flightDuration: "13h 30m" },
  { from: "tokyo", to: "beijing", distance: "2,100 km", flightDuration: "3h 30m" },
]

export function getDistance(from: string, to: string): DistanceInfo | undefined {
  return distances.find((d) => d.from === from && d.to === to) || distances.find((d) => d.from === to && d.to === from)
}
